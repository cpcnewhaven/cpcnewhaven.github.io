    ...
    fetch(url)
        ...
        .then(data => {
            ...
            document.getElementById('youtube_video').innerHTML = '<iframe width="560" height="315" src="https://www.youtube.com/embed/' + videoId + '" frameborder="0" allowfullscreen></iframe>';
        })
